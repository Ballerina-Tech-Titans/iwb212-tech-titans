...
service /organizer on new http:Listener(8082) {
    ...
    resource function post .(@http:Payload Organizer organizer) returns int|error? {
        return registerOrganizer(organizer); // Use correct function
    }
    // GET: Fetch all employees
    resource function get .() returns Organizer[]|error? {
